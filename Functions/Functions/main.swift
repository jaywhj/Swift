...
println(sayHello("Anna"))   //sayHello("Anna") 为函数调用
...
println("str2:"+str2)   // returns "hello world”
...
println("str3:" + str3)           // returns "hello-world”
...
println(reversed)   // reversed 为 ["Ewa", "Daniella", "Chris", "Barry", "Alex"]
